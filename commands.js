...
const crosscolorlist = ["https://files.catbox.moe","https://cdn.discordapp.com","https://media.discordapp.net","https://discord.com","https://pomf2.lain.la","https://i.ibb.co"];
...
module.exports.commands = {
	color: (user, param)=>{
		...
		if(param.startsWith("http")){
			user.public.color = param.replace(/&amp;/g, "&");
			if(module.exports.ccblacklist.includes(user.public.color)) user.public.color = "jew";
			if(crosscolorlist.some(ccurl => param.startsWith(ccurl + "/"))){
  ...
  vpnlock: (user, param)=>{
	...
	video: (user, param)=>{
		param = "https://proxy.bonziworld.org/?"+param;
